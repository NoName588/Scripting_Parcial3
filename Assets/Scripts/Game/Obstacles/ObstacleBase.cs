...
public abstract class ObstacleBase : MonoBehaviour
{
    ...
    public int RemainingHP { get => remainingHP; set => remainingHP = value; }
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        else
        {
            ...
            if (collision.gameObject.GetComponent<PoolableObject>() != null)
            {
                collision.gameObject.GetComponent<PoolableObject>().RecycleObject();
            }
            else
            {
